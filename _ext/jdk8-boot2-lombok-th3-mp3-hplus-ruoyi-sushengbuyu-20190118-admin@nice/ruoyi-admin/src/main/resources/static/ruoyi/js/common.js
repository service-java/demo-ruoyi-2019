...
$(function() {
	...
	if($("#tinymceEditor").length > 0){
        tinymce.init({
            ...
            language: "zh_CN",
            theme: "modern",
            plugins: 'print preview fullpage powerpaste searchreplace autolink directionality advcode visualblocks fullscreen image link media template codesample table charmap hr pagebreak nonbreaking anchor insertdatetime advlist lists textcolor wordcount tinymcespellchecker imagetools mediaembed  contextmenu colorpicker textpattern',
            toolbar1: "fullscreen preview | undo redo | styleselect | fontselect | fontsizeselect | bold italic underline strikethrough | alignleft aligncenter alignright alignjustify",
            toolbar2: "bullist numlist outdent indent | forecolor backcolor emoticons | table | link image media",
            //不能把这个设置去掉，不然图片路径会出错
            relative_urls: false,
